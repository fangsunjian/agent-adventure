...
import type { GameSettings, Story, LibraryCard, LibraryCardType } from '../types';
...
const CreatePage: React.FC<CreatePageProps> = ({ settings, storyToEdit, onSave, onClose }) => {
    const t = translations[settings.language];
    const [activeTab, setActiveTab] = useState<CreateTab>('basic');
    const [story, setStory] = useState<Story>(() => storyToEdit ? JSON.parse(JSON.stringify(storyToEdit)) : createNewStory());
