  ...
  return (
    <>
      <div className="absolute inset-0 bg-black/70 flex items-center justify-center z-30 backdrop-blur-sm p-4">
        <div className={`bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-800 rounded-lg shadow-xl flex flex-col ${
          isFullscreen && currentCard.type === 'html' 
            ? 'fixed inset-4 max-w-none max-h-none' 
            : 'w-full max-w-xl max-h-[90vh] my-auto'
          ...
          <div className={`overflow-y-auto ${
            ...
            {currentCard.type === 'html' && (
                <div className={isFullscreen ? 'h-full' : 'pt-2'}>
                    <HtmlComponentEditor
